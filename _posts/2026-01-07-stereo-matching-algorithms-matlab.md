...
![Block Matching Disparity Map](/assets/block-matching-disparity-map.png)

#### Dynamic Programming (Left–Right Axes)

![Dynamic Programming Disparity Map 1](/assets/dynamic-programming-disparity-map-1.png)

#### Dynamic Programming (Left–Disparity Axes)

![Dynamic Programming Disparity Map 2](/assets/dynamic-programming-disparity-map-2.png)

#### Semi-Global Matching

![Semi-Global Matching Disparity Map](/assets/semi-global-matching-disparity-map.png)

#### Semi-Global Block Matching

![Semi-Global Block Matching Disparity Map](/assets/semi-global-block-matching-disparity-map.png)

#### Belief Propagation (Accelerated)

![Belief Propagation Disparity Map 1](/assets/belief-propagation-disparity-map-1.png)

#### Belief Propagation (Synchronous)

![Belief Propagation Disparity Map 2](/assets/belief-propagation-disparity-map-2.png)
